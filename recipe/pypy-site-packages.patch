pypy does not store site-packages in prefix/lib/python/site-packages but
just prefix/site-packages.

diff --git a/Makefile b/Makefile
index 0812f42..46f2885 100644
--- a/Makefile
+++ b/Makefile
@@ -93,7 +93,7 @@ prefix-install: configure
...
+	cd tmp && cp -R `find . -name site-packages` site-packages
